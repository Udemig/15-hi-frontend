...
const Hero: FC = () => {
  return (
    <div className="my-6 md:my-8 lg:my-10 relative font-rubik rounded-2xl sm:rounded-3xl xl:rounded-4xl aspect-2/1 md:aspect-video lg:aspect-[2.1/1] overflow-hidden">
      ...
      <div className="absolute bottom-3 right-3 w-1/6">
        <img src="/hero-small-1.png" alt="hero-small-1" className="size-full" />
        <img src="/hero-small-2.png" alt="hero-small-2" className="size-full" />
      </div>

      <p className="bg-dark-gray text-gray absolute top-6 left-0 sm:top-8 lg:top-10 flex flex-col items-center px-2 py-2 text-[12px] sm:text-[13px] md:text-[14px] max-sm:hidden rounded-tr-md rounded-br-md">
        <span style={{ writingMode: "sideways-lr" }} className="px-2 uppercase font-semibold">
          Nike yılın ürünü
        </span>
      </p>
