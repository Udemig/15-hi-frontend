    ...
    <div className="hero padding-x padding-y">
      <div className="pt-20 xl:flex-1 max-h-230">
        <div className="mb-4 text-xl flex items-center gap-2">
          <motion.pre style={{ color: "#8df0cc" }}>{rounded}</motion.pre> <span className="mb-1">+ Araba</span>
        </div>

        <h1 className="hero-title">Özgürlüğü Hisset, Yolculuğa Başla</h1>

        <p className="hero-subtitle">
          Altın standartta hizmetle unutulmaz bir yolculuğa hazır mısın? Araç kiralama deneyimini Altın Seçenekleri ile taçlandırarak her anını özel
          kılabilirsin.
        </p>
